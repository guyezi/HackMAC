 ...
 *
 * Disassembly of iASLlJCpd4.aml, Sun Nov 17 08:46:50 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010A60 (68192)
 *     Revision         0x02
 *     Checksum         0xD6
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("iASLlJCpd4.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    /*
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDCDEBA98, 0x0350)
    ...
    Scope (_SB)
    {
                ...
                Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Z97 Chipset LPC Controller" },
                ...
                Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family PCI Express Root Port 1" },
                ...
                Name (OPTS, Zero)
                Name (RPAV, Zero)
                Method (ZDSM, 4, Serialized)  // _DSM: Device-Specific Method
                {
                    ...
                    Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "NVMe SSD Controller SM951/PM951" },
                ...
                Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family PCI Express Root Port 4" },
				"device_type", Buffer () { "PCI bridge" },
    ...
    Scope (_SB.PCI0)
    {
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Ethernet Connection I217-V" },
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family USB EHCI Controller #1" },
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family USB EHCI Controller #2" },
				"device_type", Buffer () { "USB controller" },
    ...
    Scope (_SB.PCI0)
    {
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family USB xHCI Controller" },
				"device_type", Buffer () { "USB controller" },
            ...
            Method (_PS0, 0, Serialized)  // _PS0: Power State 0
            {
                ...
                If (LOr (LEqual (PCHG, One), LAnd (LEqual (PCHV (), WPTL), LOr (LEqual (PCHP, 
                    0x40), LEqual (PCHP, 0x41)))))
                {
                    Store (Zero, SWAI)
                    Store (Zero, SAIP)
                }
    ...
    Scope (_SB.PCI0)
    {
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family HD Audio Controller" },
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family SATA Controller [AHCI Mode]" },
            ...
            Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family SMBus Controller" },
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDCC46E98, 0x10)
                ...
                If (LEqual (Arg0, ToUUID ("1730e71d-e5dd-4a34-be57-4d76b6a2fe37")))
                {
                    If (LEqual (Arg2, Zero))
                    {
                        ...
                        Else
                        {
                            Return (Package ()
			{
				"model", Buffer () { "9 Series Chipset Family ME Interface #1" },
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            "937308352451Genuine NVIDIA Certified SLI Ready Motherboard for GIGABYTE Z97X-UD3H  ebd1-Copyright 2014 NVIDIA Corporation All Rights Reserved-950249559801(R)"
        })
        Device (WMI1)
        {
